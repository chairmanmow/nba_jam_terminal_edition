    ...
    function _handlePassComplete(stateData) {
        ...
        if (stateData.intercepted && stateData.receiver) {
            ...
            try {
                ...
                f.open("a");
                f.writeln("Pass complete: set ballCarrier via state.set()");
                ...
                // Check if gameState was actually mutated
                f.writeln("  gameState.ballCarrier after set: " + (gameState.ballCarrier && gameState.ballCarrier.playerData ? gameState.ballCarrier.playerData.name : "NULL/undefined"));
                f.close();
            } catch (e) { }

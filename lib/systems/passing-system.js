 ...
 */
    ...
    function _handlePassComplete(stateData) {
        ...
        if (typeof log === 'function') {
            log(LOG_DEBUG, "[PASSING-SYSTEM] _handlePassComplete fired! intercepted=" + stateData.intercepted + 
                ", receiver=" + (stateData.receiver ? stateData.receiver.playerData.name : "null"));
        }
        ...
        if (stateData.intercepted && stateData.receiver) {
            ...
            if (typeof log === 'function') {
                log(LOG_DEBUG, "[PASSING-SYSTEM] Setting ballCarrier to interceptor: " + stateData.receiver.playerData.name);
            }
            ...
            // SUCCESSFUL PASS
            if (typeof log === 'function') {
                log(LOG_DEBUG, "[PASSING-SYSTEM] Setting ballCarrier to receiver: " + stateData.receiver.playerData.name);
            }
            ...
            if (typeof log === 'function') {
                ...
                log(LOG_DEBUG, "[PASSING-SYSTEM] After set, ballCarrier is: " + (currentCarrier ? currentCarrier.playerData.name : "NULL"));
            }

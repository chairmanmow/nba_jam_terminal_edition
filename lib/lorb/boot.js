...
(function () {
    ...
    // Class-based network service (Wave 24)
    // Single instance per session, attached to ctx, handles all JSONClient operations
    load(ROOT + "services/network-service.js");
    
    // Backward-compatible shim for LORB.Multiplayer.Challenges
    // Delegates to ctx._networkService - allows gradual migration
    load(ROOT + "multiplayer/challenges_shim.js");

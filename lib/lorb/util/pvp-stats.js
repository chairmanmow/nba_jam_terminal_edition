...
(function() {
    ...
    function getNews(limit) {
        ...
        try {
            if (LORB && LORB.Persist && LORB.Persist._client) {
                var client = LORB.Persist._client;
                var data = client.read("nba_jam", "lorb.pvpNews", 1);
    ...
    /**
     * Add a news entry to the global news feed
     * 
     * @param {Object} entry - News entry object
    ...
    function addNews(entry) {
        try {
            ...
            // Write back
            client.write("nba_jam", "lorb.pvpNews", data, 2);

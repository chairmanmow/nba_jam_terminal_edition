...
(function() {
    ...
    function playPlayoffMatch(ctx) {
        ...
        var resolution;
        if (oppOnline) {
            // TODO: Implement PvP playoff match flow
            // For now, fall back to ghost match
            resolution = LORB.Playoffs.RESOLUTION.GHOST;
        } else {
            resolution = LORB.Playoffs.RESOLUTION.GHOST;
        }
        
        // Run the match
        var result = runPlayoffMatch(bracket, match, mySnapshot, oppSnapshot, resolution, ctx);

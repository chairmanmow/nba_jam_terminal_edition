...
(function () {
    ...
    function getTeamColors(city) {
        ...
        return {
            ...
            fgAttr: getAttrFromName(teamColors.ansi_fg),
            bgAttr: getAttrFromName(teamColors.ansi_bg),
            fgAccentAttr: getAttrFromName(teamColors.ansi_fg_accent),
            bgAltAttr: getAttrFromName(teamColors.ansi_bg_alt)
        };
    }

...
(function() {
    ...
    function createBracket(seasonNumber, qualifiedPlayers) {
        ...
        // Build initial round matchups
        var matches = buildFirstRoundMatches(seededPlayers, bracketSize);
     ...
     */
    function buildFirstRoundMatches(seededPlayers, bracketSize) {
        var matches = [];
        ...
        for (var i = 0; i < pairings.length; i++) {
            ...
            var match = {
                ...
                createdAt: nowMs(),
                softDeadline: nowMs() + hoursToMs(PlayoffConfig.ROUND_SOFT_DEADLINE_HOURS || 72),
                hardDeadline: nowMs() + hoursToMs(PlayoffConfig.ROUND_HARD_DEADLINE_HOURS || 168),
                completedAt: null
            };

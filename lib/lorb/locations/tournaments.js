...
(function() {
    ...
    function showRankingsView(ctx, players, onlinePlayers, myGlobalId, sortMode) {
        ...
        if (footerFrame) {
            ...
            footerFrame.putmsg(" \1h\1w[ENTER]\1n\1c View \1h\1w[S]\1n\1c Sort \1h\1w[2]\1n\1c Leaders \1h\1w[3]\1n\1c Records \1h\1w[P]\1n\1r PvP \1h\1w[O]\1n\1y Playoffs \1h\1w[Q]\1n\1c Back");
        }
        ...
        var choice = view.menu(menuItems, { y: 1, hotkeys: "S23PO", onIdle: onIdleCallback });
    ...
    function showLeadersView(ctx, players, myGlobalId, statIndex) {
        ...
        if (footerFrame) {
            ...
            footerFrame.gotoxy(1, 2);
            footerFrame.putmsg(" \1h\1w[\x1B/\x1A]\1n\1c Stat \1h\1w[1]\1n\1c Rankings \1h\1w[3]\1n\1c Records \1h\1w[P]\1n\1r PvP \1h\1w[O]\1n\1y Playoffs \1h\1w[Q]\1n\1c Back");
        }
    ...
    function showRecordsView(ctx, players, myGlobalId, statIndex) {
        ...
        if (footerFrame) {
            ...
            footerFrame.gotoxy(1, 2);
            footerFrame.putmsg(" \1h\1w[\x1B/\x1A]\1n\1c Stat \1h\1w[1]\1n\1c Rankings \1h\1w[2]\1n\1c Leaders \1h\1w[P]\1n\1r PvP \1h\1w[O]\1n\1y Playoffs \1h\1w[Q]\1n\1c Back");
        }

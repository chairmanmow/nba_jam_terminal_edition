...
(function() {
    ...
    function runRichView(ctx) {
        while (true) {
            ...
            var menuItems = [
                ...
                { text: "Stats & Records", value: "stats", hotkey: "5" },
    ...
    function runLegacy(ctx) {
        while (true) {
            ...
            LORB.View.line("");
            LORB.View.line("[1] Courts  [2] Club  [3] Gym  [4] Shop  [5] Stats  [Q] Quit");
            LORB.View.line("");
            var choice = LORB.View.prompt("Choice: ");
            var map = { "1": "courts", "2": "club", "3": "gym", "4": "shop", "5": "stats", "Q": "quit", "RESET": "reset" };

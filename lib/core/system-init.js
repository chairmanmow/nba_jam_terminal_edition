...
/**
 * Expose systems to global scope for legacy code
 * These become module-level globals like all other game functions
 * 
 * @param {Object} systems - The initialized systems
 */
function exposeSystemsGlobally(systems) {
    // Export to global scope (same pattern as other game globals)
    stateManager = systems.stateManager;
    eventBus = systems.eventBus;
    passingSystem = systems.passingSystem;
    possessionSystem = systems.possessionSystem;

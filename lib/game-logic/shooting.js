...
function attemptShot() {
    ...
    if (!globalThis.shootingSystem) {
        throw new Error("ARCHITECTURE ERROR: shootingSystem not initialized. attemptShot() requires shooting system.");
    }
    
    return globalThis.shootingSystem.attemptShot(player);
}

...
function attemptSteal() {
    ...
    if (distance < GAME_BALANCE.DEFENSE.STEAL_MAX_DISTANCE) {
        ...
        if (Math.random() < chance) {
            ...
            stateManager.set("reboundActive", false, "steal_success");
            stateManager.set("ballCarrier", defender, "steal_success");
            stateManager.set("currentTeam", "teamA", "steal_success");
            triggerPossessionBeep(systems);
            resetBackcourtState();
            stateManager.set("ballHandlerStuckTimer", 0, "steal_success");
            stateManager.set("ballHandlerAdvanceTimer", 0, "steal_success");
            stateManager.set("consecutivePoints.teamB", 0, "steal_success");
            stateManager.set("shotClock", 24, "steal_success");
            stateManager.set("ballHandlerLastX", defender.x, "steal_success");
            stateManager.set("ballHandlerLastY", defender.y, "steal_success");
            stateManager.set("ballHandlerFrontcourtStartX", defender.x, "steal_success");
            stateManager.set("ballHandlerProgressOwner", defender, "steal_success");
